...
def test_explore_distribution_and_registration():
    ...
    assert project["readme"]=="README.md" and project["dependencies"][0]=="ai-convos-db>=0.6,<0.7" and project["entry-points"]["convos.commands"]=={"explore":"ai_convos_explore:register"} and {c.name or c.callback.__name__ for c in app.registered_commands}=={"related","trail"}
