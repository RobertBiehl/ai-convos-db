...
def test_distribution_metadata_registration_and_help():
    ...
    assert project["dependencies"][:2]==["ai-convos-db>=0.7,<0.8","ai-convos-redact>=0.7,<0.8"] and project["entry-points"]["convos.commands"]=={"resume":"ai_convos_resume:register"} and core["optional-dependencies"]["resume"]==["ai-convos-resume>=0.7,<0.8"]
