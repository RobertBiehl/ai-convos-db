...
def test_distribution_metadata_registration_and_help():
    ...
    assert project["dependencies"][:2]==["convos>=0.8,<0.9","convos-redact>=0.8,<0.9"] and project["entry-points"]["convos.commands"]=={"resume":"ai_convos_resume:register"} and core["optional-dependencies"]["resume"]==["convos-resume>=0.8,<0.9"]
